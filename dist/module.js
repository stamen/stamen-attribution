...
function $cf838c15c8b009ba$var$_arrayWithHoles(arr) {
    if (Array.isArray(arr)) return arr;
}
var $cf838c15c8b009ba$var$setStyle = function setStyle(el, styleObj) {
    Object.entries(styleObj).forEach(function(_ref) {
        var _ref2 = $cf838c15c8b009ba$var$_slicedToArray(_ref, 2), k = _ref2[0], v = _ref2[1];
        el.style[k] = v;
    });
};
var $cf838c15c8b009ba$var$stamenLogo = document.createElement("img");
$cf838c15c8b009ba$var$stamenLogo.src = "data:image/svg+xml;charset=utf-8,".concat($8d7b57d63e63d52a$exports.stamenSvg);
var $cf838c15c8b009ba$var$siteLink = document.createElement("a");
$cf838c15c8b009ba$var$siteLink.href = "https://stamen.com";
var $cf838c15c8b009ba$var$attribution = document.createElement("div");
var $cf838c15c8b009ba$var$stamenLogoStyle = {
    height: "24px",
    position: "absolute",
    bottom: "-1px"
};
$cf838c15c8b009ba$var$setStyle($cf838c15c8b009ba$var$stamenLogo, $cf838c15c8b009ba$var$stamenLogoStyle);
var $cf838c15c8b009ba$var$siteLinkStyle = {
    width: "110px",
    position: "relative"
};
$cf838c15c8b009ba$var$setStyle($cf838c15c8b009ba$var$siteLink, $cf838c15c8b009ba$var$siteLinkStyle);
var $cf838c15c8b009ba$var$attributionStyle = {
    position: "fixed",
    bottom: "0px",
    right: "12px",
    zIndex: 10000,
...
$cf838c15c8b009ba$var$setStyle($cf838c15c8b009ba$var$attribution, $cf838c15c8b009ba$var$attributionStyle);
$cf838c15c8b009ba$var$siteLink.appendChild($cf838c15c8b009ba$var$stamenLogo);
$cf838c15c8b009ba$var$attribution.appendChild($cf838c15c8b009ba$var$siteLink);
document.body.appendChild($cf838c15c8b009ba$var$attribution);
var $cf838c15c8b009ba$var$updateStyle = function updateStyle(styleObj) {
    for(var _i2 = 0, _Object$entries = Object.entries(styleObj); _i2 < _Object$entries.length; _i2++){
        var _Object$entries$_i = $cf838c15c8b009ba$var$_slicedToArray(_Object$entries[_i2], 2), k = _Object$entries$_i[0], v = _Object$entries$_i[1];
        $cf838c15c8b009ba$var$attribution.style[k] = v;
    }
}; // First link does not get a spacer because it's next to the logo
$cf838c15c8b009ba$exports.updateStyle = $cf838c15c8b009ba$var$updateStyle;
var $cf838c15c8b009ba$var$marker = false;
var $cf838c15c8b009ba$var$addLink = function addLink(url, text) {
    $cf838c15c8b009ba$var$siteLink.style.marginRight = "6px";
    var addedLink = document.createElement("a");
    addedLink.innerHTML = text;
    addedLink.href = url;
    var spacer = document.createElement("div");
    spacer.innerHTML = $cf838c15c8b009ba$var$marker ? "|" : " ";
    $cf838c15c8b009ba$var$attribution.appendChild(spacer);
    $cf838c15c8b009ba$var$attribution.appendChild(addedLink);
    var addedLinkStyle = {
        color: "white",
        marginRight: "6px",
        marginBottom: "6px",
    ...
    $cf838c15c8b009ba$var$setStyle(addedLink, addedLinkStyle);
    $cf838c15c8b009ba$var$setStyle(spacer, addedLinkStyle);
    $cf838c15c8b009ba$var$marker = true;
};
$cf838c15c8b009ba$exports.addLink = $cf838c15c8b009ba$var$addLink;
